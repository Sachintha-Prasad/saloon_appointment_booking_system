...
class StylistAppointmentCard extends StatelessWidget {
  final Map<String, dynamic> appointment;

  const StylistAppointmentCard({super.key, required this.appointment});
  ...
  Widget build(BuildContext context) {
    ...
    final client = appointment['clientId'] ?? {};
    final name = SBHelperFunctions.capitalizeString(client['name']) ?? 'Unknown';
    final email = client['email'] ?? '';
    final time = _getTimeFromDate(appointment['date']);
    final slot = appointment['slotNumber']?.toString() ?? '-';
